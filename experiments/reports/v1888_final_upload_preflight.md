...
| current_upload_sha_matches_metadata | yes | `c9e4d0d236c08296f6a5501219d05eb1c5861345cd1de7dcbae5c11c83e75912` |
| manifest_row_found | yes | `rolecap_queue#5:v1846e` |
| manifest_candidate_matches | yes | `v1846e` |
| manifest_status_pass | yes | `pass` |
| manifest_sha_matches_upload | yes | `c9e4d0d236c08296f6a5501219d05eb1c5861345cd1de7dcbae5c11c83e75912` |
| manifest_output_exists | yes | `experiments/final_submission_package/rolecap_queue/05_v1846e_queue05_v1842e_rolecap099_private.csv` |
| manifest_output_sha_matches_upload | yes | `experiments/final_submission_package/rolecap_queue/05_v1846e_queue05_v1842e_rolecap099_private.csv` |
| validator_ok | yes | `OK: 397 predictions validated` |
| pre_upload_guard_ready | yes | `PRE_UPLOAD_GUARD; UPLOAD_READY=yes; ATTEMPT_CONTEXT=followup_from_records; UPLOAD_PATH=experiments/final_submission_package/current_upload/submission.csv; CANDIDATE=v1846e; GROUP=rolecap_queue; ORDER=5; SHA256=c9e4d0d236c08296f6a5501219d05eb1c5861345cd1de7dcbae5c11c83e75912; ROWS=397; REPORT=experiments/reports/v1883_pre_upload_guard.md; JSON=experiments/reports/v1883_pre_upload_guard.json` |
