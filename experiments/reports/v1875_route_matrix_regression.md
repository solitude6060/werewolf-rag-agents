...
| label | group | order | score | previous_score | recommended_next | status | pass |
| --- | --- | --- | --- | --- | --- | --- | --- |
| order1_top3 | scoreonly_safe_queue | 1 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| scoreonly_safe_queue_order3_top3 | scoreonly_safe_queue | 3 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| scoreonly_safe_queue_order4_top3 | scoreonly_safe_queue | 4 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
| scoreonly_safe_queue_order5_positive | scoreonly_safe_queue | 5 | 0.47200 |  | NO_SCOREONLY_SAFE_QUEUE_REMAINING: keep best verified score or choose contingency manually. | non_concrete_ok | yes |
| scoreonly_safe_queue_order5_regression | scoreonly_safe_queue | 5 | 0.46600 |  | NO_SCOREONLY_SAFE_QUEUE_REMAINING: keep best verified score or choose contingency manually. | non_concrete_ok | yes |
| scoreonly_safe_queue_order5_top3 | scoreonly_safe_queue | 5 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| portfolio_queue_order3_top3 | portfolio_queue | 3 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| portfolio_queue_order4_top3 | portfolio_queue | 4 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| portfolio_queue_order5_top3 | portfolio_queue | 5 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| charprior_order2_top3 | charprior_queue | 2 | 0.50672 | 0.48001 | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| charprior_queue_order3_top3 | charprior_queue | 3 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| charprior_queue_order4_top3 | charprior_queue | 4 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
...
| charprior_queue_order5_top3 | charprior_queue | 5 | 0.50672 |  | STOP: score exceeds top-3 threshold. | non_concrete_ok | yes |
